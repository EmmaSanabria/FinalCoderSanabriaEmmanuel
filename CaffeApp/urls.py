...
urlpatterns = [
    ...
    path('reservations/', search_messages, name= 'reservations'),
    ...
    path('show-user/<pk>/', UserProfileView.as_view(), name= 'show-user'),
    ...
    #Url Paginas no administrador
    path('lists-promo-noad/', PromoListNoad.as_view(), name= 'lists-promo-noad'),
    path('detail-promo-noad/<pk>/', PromoDetailNoad.as_view(), name= 'detail-promo-noad'),
    path('lists-staff-noad/', StaffListNoad.as_view(), name= 'lists-staff-noad'),
    path('detail-staff-noad/<pk>/', StaffDetailNoad.as_view(), name= 'detail-staff-noad'),  
    path('lists-product-noad/', ProductListNoad.as_view(), name= 'lists-product-noad'),
    path('detail-product-noad/<pk>/', ProductDetailNoad.as_view(), name= 'detail-product-noad'),  
